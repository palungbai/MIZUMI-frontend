  ...
  return (
    <>
      <div className="relative flex flex-col w-1080 h-1920 overflow-hidden bg-[url('/05-display-page/display-page-bg.png')] bg-contain -z-30">
        <div className='absolute w-[810px] h-[810px] bottom-[360px] left-[140px] rounded-2xl -z-20'>
          <img src={sunscreenUrl} alt='no sunscreen' width="810px" height="810px" className="rounded-2xl" />
        </div>
